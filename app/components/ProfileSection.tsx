		...
		<div className="w-full py-8 md:py-0 bg-white dark:bg-gray-900 px-6 pt-16 sm:pt-0">
			<div className="space-y-8 text-center">
				...
				<div className="space-y-3">
					<h1 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white">Tyler Zaeske</h1>
					<h2 className="text-lg md:text-xl text-gray-600 dark:text-gray-400">Module Developer & Student</h2>
					...
					<p className="text-sm md:text-base text-gray-600 dark:text-gray-400 max-w-xs mx-auto leading-relaxed">
						18 year old student studying Computer Science and software developer for Osint Industries
					</p>
				</div>
				...
				<div className="space-y-4">
					...
					<div className="flex items-center justify-center space-x-2">
						...
						<a href="mailto:byro@osint.industries" className="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
							byro@osint.industries
						</a>
					</div>
					...
					<div className="flex items-center justify-center space-x-2">
						...
						<span className="text-sm text-gray-600 dark:text-gray-400">Boulder, CO</span>
					</div>

					{/* Social Links */}
					<div className="flex items-center justify-center space-x-4 pt-2">
						<a
							href="https://github.com/ByroBuff"
							target="_blank"
						...
						<a
							href="https://www.linkedin.com/in/tyler-zaeske-10a310249"
							target="_blank"
							rel="noopener noreferrer"
							className="p-2 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white"
						>
