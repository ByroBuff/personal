	...
	const experiences = [
		{
			...
			highlights: 'Scraping and Reverse Engineering to gather data on a selector from various websites, working with large databases',
		},
		{
			role: 'Full Stack Developer',
			company: 'Hebbian',
			period: 'Feb 2023 - Apr 2024',
			highlights: 'Built scalable web application using VueJS and Nuxt',
		},
	];
